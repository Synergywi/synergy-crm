...
type Contact = { id: number; name: string; email: string; company?: string; userLog: LogItem[] };
...
const seed: Contact[] = [
  ...
  { id: 2, name: "Jamie Wu", email: "jamie@northwind.example", company: "Northwind",
    userLog: [{ at: new Date(Date.now()-1000*60*60*48).toISOString(), ip: "198.51.100.5", ua: "Edge 124 / Windows", durationSec: 180 }]}
];
...
export default function ContactsPage() {
  ...
  function simulateLogin() {
    const entry: LogItem = { at: new Date().toISOString(), ip: "198.51.100.7", ua: "Safari / iOS", durationSec: Math.floor(120 + Math.random()*600) };
    ...
    <div className="grid">
      ...
      <div className="card span-8">
        ...
        {active.userLog.length === 0 ? (
          ...
          <table className="table">
            <thead><tr><th>When</th><th>Duration</th><th>IP</th><th>Agent</th></tr></thead>
            <tbody>
