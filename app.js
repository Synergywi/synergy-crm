...
if(act==='viewCompany'){App.set({companyViewMode:'view'});return;}
  ...
  if(act==='selectFiles'){App.state.currentUploadTarget=arg||((App.state.currentCaseId||'')+'::General'); const fi=document.getElementById('case-file-any')||document.getElementById('file-input'); if(fi) fi.click(); else alert('File input not found'); return;}
...
document.addEventListener('change',e=>{
  ...
  // case docs upload
  if(e.target && (e.target.id==='case-file-any' || e.target.id==='file-input')){
